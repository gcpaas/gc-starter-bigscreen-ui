...
import remoteComponents from '@/remoteDataSet/exports.js'
  ...
  methods: {
    ...
    openAddForm (type) {
      ...
      if (remoteComponents.length > 0) {
        ...
        console.log(remoteComponentData)
      }
      this.remoteComponent = typeIndex > -1 ? components[typeIndex] : remoteComponentData?.vueFile
