...
import ColorSelect from 'packages/common/ColorSelect/index'
import ColorPicker from 'packages/common/ColorPicker/index.vue'
import PaddingSetting from 'packages/common/PaddingSetting/index'
import GradualSetting from 'packages/common/GradualSetting/index'
export default {
