  ...
  methods: {
    ...
    getThemeConfig (themeName) {
      ...
      this.pageInfo.pageConfig.cacheDataSets?.map((cacheDataSet) => {
        this.$store.dispatch('bigScreen/getCacheDataSetData', { appCode: this.pageInfo.appCode, dataSetId: cacheDataSet.dataSetId })
        this.$store.dispatch('bigScreen/getCacheDataFields', { appCode: this.pageInfo.appCode, dataSetId: cacheDataSet.dataSetId })
      })
    },
    // 改变
...
.bs-overall-wrap {
  ...
  {
    background: $-bs-inner-background-color;
    color: $-bs-inner-text-color;
    border: 0 !important;
  }
  ...
  /deep/ .el-table {
    background: $-bs-inner-background-color;
    border-bottom: 1px solid $-bs-text-color;
  }

  /deep/ .el-table__cell {
    background: $-bs-inner-background-color !important;
    color: $-bs-text-color !important;
    border-color: $-bs-inner-text-color !important;
  }
}
.bg-img {
  width: 200px;
