...
importComponentSettingConfig(require.context('../BasicComponents', true, /\.js$/))
importComponentSettingConfig(require.context('../Borders', true, /\.js$/))
importComponentSettingConfig(require.context('../Decorations', true, /\.js$/))
