...
importComponents(require.context('../BasicComponents', true, /\index.vue$/))
importComponents(require.context('../Borders', true, /\index.vue$/))
importComponents(require.context('../Decorations', true, /\index.vue$/))
