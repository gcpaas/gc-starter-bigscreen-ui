...
importComponentSetting(require.context('../BasicComponents', true, /\.vue$/))
importComponentSetting(require.context('../Borders', true, /\.vue$/))
importComponentSetting(require.context('../Decorations', true, /\.vue$/))
