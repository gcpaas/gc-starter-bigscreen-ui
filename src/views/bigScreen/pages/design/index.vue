...
import PageTopSetting from './PageDesignTop'
import Render from '../../components/Render'
import { mapActions, mapMutations, mapState } from 'vuex'
import SketchDesignRuler from '@/views/bigScreen/common/RulerTool/SketchRuler'
import { G2 } from '@antv/g2plot'
import multipleSelectMixin from 'gc-starter-bigscreen/mixins/multipleSelectMixin'
import { getThemeConfig } from '../../api/bigScreenApi'
