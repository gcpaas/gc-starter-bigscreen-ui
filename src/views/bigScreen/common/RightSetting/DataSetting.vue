...
import ComponentRelation from '../../common/ComponentRelation'
import dataSetSelect from '../../../common/DataSetSetting/index'
import { mapState } from 'vuex'
import { getDataSetDetails } from '../../api/bigScreenApi'
export default {
  name: 'DataSetting',
  components: {
    ComponentRelation,
