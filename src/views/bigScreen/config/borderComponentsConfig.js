...
import getComponentConfig from 'gc-starter-bigscreen/utils/getBorderComponentsConfig'
// 批量引入配置文件
import { setModules, dataModules } from 'gc-starter-bigscreen/bulkImport/configImport'
const typeLIst = ['border1', 'border2', 'border3', 'border4', 'border5', 'border6', 'border7', 'border8', 'border9', 'border10', 'border11', 'border12', 'border13', 'border14']
let basicConfigList = []
