...
import getComponentConfig from 'gc-starter-bigscreen/utils/getComponentConfig'
import linkageConfig from 'gc-starter-bigscreen/config/linkageConfig'
...
export default function (customConfig) {
  return {
    ...
    dataSource: {
      className:
        'com.gccloud.starter.lowcode.page.chart.components.datasource.DataSetDataSource',
